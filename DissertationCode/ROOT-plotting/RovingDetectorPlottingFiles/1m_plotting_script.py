...
with open('LT_1p0_extended.csv', 'r') as file:
...
plt.legend()
plt.grid(True)
plt.savefig('/home/leonardo/Pictures/LT_1p0_extended_wErrors.png', dpi = 300)
plt.show()
...
with open('LT_0p1_extended.csv', 'r') as file:
...
plt.legend()
plt.grid(True)
plt.savefig('/home/leonardo/Pictures/LT_0p1_extended_wErrors.png', dpi = 300)
